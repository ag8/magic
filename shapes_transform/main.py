        ...
        for epoch in range(training_epochs):
            ...
            for i in range(total_batch):
                ...
                if epoch % 10 == 0 and i == 3:
                    ...
                    # predictions = accuracy_testing_overlap_areas


                    predictions = np.zeros(np.shape(predictions))
                    ...
                    send_data_to_poor_mans_tensorboard(mse)
                    ...
                    for i in xrange(0, len(predictions)):
                        ...
                        value = accuracy_testing_overlap_areas[i]

                        if value > FLAGS.THRESHOLD_VAL and prediction > FLAGS.THRESHOLD_VAL:
                            num_correct += 1
                    ...
                    accuracy = 100. * float(num_correct) / float(len(predictions))
            ...
            print(("Average loss: " + str(avg_loss) + "").ljust(35))
