...
with tf.Session() as sess:
    ...
    network_architecture = \
        dict(num_neurons_recognition_layer_1=500,  # 1st layer encoder neurons
             ...
             num_input_neurons=FLAGS.IMAGE_SIZE * FLAGS.IMAGE_SIZE * FLAGS.NUM_LAYERS,  # MNIST data input (img shape: 28*28)
    ...
    try:
        ...
        for i in range(5):
            ...
            plt.imshow(x_reconstruct[i].reshape(200, 200, FLAGS.NUM_LAYERS)[:, :, 0], vmin=0, vmax=1, cmap="gray")
